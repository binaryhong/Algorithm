def solution(survey, choices):
        ...
        for j in range(8):
            if choices[i] == 1:  # 매우 비동의
                if survey[i][0] == scoreList[j][0]:
                    for k in range(8):
                        if survey[i][0] == scoreList[k][0]:
                            scoreList[k][1] += 3
            elif choices[i] == 2:  # 비동의 # MJ
                if survey[i][0] == scoreList[j][0]:
                    for k in range(8):
                        if scoreList[k][0] == survey[i][0]:
                            scoreList[k][1] += 2
    ...
    #     answer += scoreList[1][1]
    # elif scoreList[0][1] == scoreList[1][1]:
    #     if ord(scoreList[0][1]) > ord(scoreList[1][1]):
    #         answer += scoreList[1][1]
    #     elif ord(scoreList[0][1]) < ord(scoreList[1][1]):
    #         answer += scoreList[0][1]
